...
def fairino_tf(context):
    ...
    return [machinery_robot_tf_node,robot_state_publisher_node,machinery_camera_tf_node,machinery_tool_frame_node,rviz_node]
...
def generate_launch_description():
    ...
    return LaunchDescription(
        ...
        [OpaqueFunction(function=fairino_tf)]
    )