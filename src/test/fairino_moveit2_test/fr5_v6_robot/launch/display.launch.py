...
def declare_params():
  urdf_path_arg = DeclareLaunchArgument(
    'urdf_path',
    default_value=PathJoinSubstitution([FindPackageShare('fr5_v6_robot'), 'urdf', 'fr5_v6_robot.urdf']),
    description='URDF 文件路径'
  )

  rviz_path_arg = DeclareLaunchArgument(
    'rviz_path',
    default_value=PathJoinSubstitution([FindPackageShare('fr5_v6_robot'), 'config', 'rviz.rviz']),
