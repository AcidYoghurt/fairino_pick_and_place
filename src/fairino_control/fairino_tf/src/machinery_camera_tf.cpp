...
public:
    MachineryCameraTF() : Node("machinery_camera_tf")
    {
        ...
        // 打开 yaml文件
        std::string yaml_file_path = config_path+"/eye_in_hand_calibrate.calib";
...
private:
    ...
    // 所需参数
    std::string calibration_type,config_path,robot_effector_frame,tracking_base_frame,robot_base_frame;
